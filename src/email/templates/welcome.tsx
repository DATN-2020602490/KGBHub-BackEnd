      ...
      <Body className={main}>
        <Container className={container} style={{ maxWidth: "unset" }}>
          ...
          <Text className="text-start text-base">
            You've joined the <b>KGB Hub</b> elearning community through Gmail.
          </Text>
          <Img
          ...
          />
          <Text className="text-start text-base">
            At <b>KGB Hub</b>, we are committed to providing you with the best
            possible learning experience. We offer a wide range of courses, from
            basic skills to advanced programs, all designed to help you achieve
            your goals.
          </Text>
          <Text className="text-start text-base">
          ...
          <Text className="text-start text-base">
            ...
            experience at <b>KGB Hub</b>. We encourage you to get involved in
            our campus community and take advantage of all that we have to
            offer.
          </Text>
          <Text className="text-start text-dm">
            Sincerely,
